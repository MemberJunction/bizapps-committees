 ...
 * App: mj_api
 * Dependency tree: 88 packages walked, 3 contain @RegisterClass
 *
...
// @mj-biz-apps/tasks-server (1 classes)
import {
    OverdueTaskNotificationJob,
} from '@mj-biz-apps/tasks-server';
...
export const CLASS_REGISTRATIONS_COUNT = 47;
