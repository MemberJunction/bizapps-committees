...
IF NOT EXISTS (SELECT 1 FROM sys.schemas WHERE name = '__mj_BizAppsCommon')
...
---------------------------------------------------------------------------
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = '__mj_BizAppsCommon' AND TABLE_NAME = 'OrganizationType')
...
---------------------------------------------------------------------------
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = '__mj_BizAppsCommon' AND TABLE_NAME = 'AddressType')
...
---------------------------------------------------------------------------
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = '__mj_BizAppsCommon' AND TABLE_NAME = 'ContactType')
...
---------------------------------------------------------------------------
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = '__mj_BizAppsCommon' AND TABLE_NAME = 'RelationshipType')
...
---------------------------------------------------------------------------
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = '__mj_BizAppsCommon' AND TABLE_NAME = 'Person')
...
---------------------------------------------------------------------------
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = '__mj_BizAppsCommon' AND TABLE_NAME = 'Organization')
...
---------------------------------------------------------------------------
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = '__mj_BizAppsCommon' AND TABLE_NAME = 'Address')
...
---------------------------------------------------------------------------
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = '__mj_BizAppsCommon' AND TABLE_NAME = 'AddressLink')
...
---------------------------------------------------------------------------
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = '__mj_BizAppsCommon' AND TABLE_NAME = 'ContactMethod')
...
---------------------------------------------------------------------------
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = '__mj_BizAppsCommon' AND TABLE_NAME = 'Relationship')
...
---------------------------------------------------------------------------
IF NOT EXISTS (SELECT 1 FROM sys.extended_properties ep INNER JOIN sys.schemas s ON ep.major_id = s.schema_id WHERE s.name = '__mj_BizAppsCommon' AND ep.minor_id = 0 AND ep.name = 'MS_Description' AND ep.class = 3)
...
---------------------------------------------------------------------------
IF NOT EXISTS (SELECT 1 FROM sys.extended_properties WHERE major_id = OBJECT_ID('__mj_BizAppsCommon.OrganizationType') AND minor_id = 0 AND name = 'MS_Description')
BEGIN
...
---------------------------------------------------------------------------
IF NOT EXISTS (SELECT 1 FROM sys.extended_properties WHERE major_id = OBJECT_ID('__mj_BizAppsCommon.AddressType') AND minor_id = 0 AND name = 'MS_Description')
BEGIN
...
---------------------------------------------------------------------------
IF NOT EXISTS (SELECT 1 FROM sys.extended_properties WHERE major_id = OBJECT_ID('__mj_BizAppsCommon.ContactType') AND minor_id = 0 AND name = 'MS_Description')
BEGIN
...
---------------------------------------------------------------------------
IF NOT EXISTS (SELECT 1 FROM sys.extended_properties WHERE major_id = OBJECT_ID('__mj_BizAppsCommon.RelationshipType') AND minor_id = 0 AND name = 'MS_Description')
BEGIN
...
---------------------------------------------------------------------------
IF NOT EXISTS (SELECT 1 FROM sys.extended_properties WHERE major_id = OBJECT_ID('__mj_BizAppsCommon.Person') AND minor_id = 0 AND name = 'MS_Description')
BEGIN
...
---------------------------------------------------------------------------
IF NOT EXISTS (SELECT 1 FROM sys.extended_properties WHERE major_id = OBJECT_ID('__mj_BizAppsCommon.Organization') AND minor_id = 0 AND name = 'MS_Description')
BEGIN
...
---------------------------------------------------------------------------
IF NOT EXISTS (SELECT 1 FROM sys.extended_properties WHERE major_id = OBJECT_ID('__mj_BizAppsCommon.Address') AND minor_id = 0 AND name = 'MS_Description')
BEGIN
...
---------------------------------------------------------------------------
IF NOT EXISTS (SELECT 1 FROM sys.extended_properties WHERE major_id = OBJECT_ID('__mj_BizAppsCommon.AddressLink') AND minor_id = 0 AND name = 'MS_Description')
BEGIN
...
---------------------------------------------------------------------------
IF NOT EXISTS (SELECT 1 FROM sys.extended_properties WHERE major_id = OBJECT_ID('__mj_BizAppsCommon.ContactMethod') AND minor_id = 0 AND name = 'MS_Description')
BEGIN
...
---------------------------------------------------------------------------
IF NOT EXISTS (SELECT 1 FROM sys.extended_properties WHERE major_id = OBJECT_ID('__mj_BizAppsCommon.Relationship') AND minor_id = 0 AND name = 'MS_Description')
BEGIN
