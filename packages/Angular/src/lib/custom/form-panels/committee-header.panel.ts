...
const SETTING_KEY = 'mj.form.committees.headerCollapsed';

@RegisterClassEx(BaseFormPanel, {
    key: 'form-panel:Committees:header',
    metadata: {
...
@Component({
    selector: 'bizapps-committee-header-panel',
    standalone: true,
            ...
            <div class="mj-entity-hero-header">
                <div class="mj-hero-top">
                    <div class="mj-hero-identity">
                        ...
                        <div>
                            <h1 class="mj-hero-title">{{ Committee.Name || 'Governance Committee' }}</h1>
                ...
                @if (!IsCollapsed) {
                    <div class="mj-hero-metrics-row">
                        <div class="mj-hero-metric">
                            <span class="mj-hero-metric-label">Committee ID</span>
                            <span class="mj-hero-metric-val">{{ Committee.ID.substring(0, 8) }}</span>
                        </div>
                        <div class="mj-hero-metric">
                            <span class="mj-hero-metric-label">Governance Body</span>
                            <span class="mj-hero-metric-val" style="color: #38bdf8;">Board Committee</span>
                        </div>
                    </div>
                }
            </div>
...
export class CommitteeHeaderPanel extends BaseFormPanel<mjBizAppsCommitteesCommitteeEntity> {
